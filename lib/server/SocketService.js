...
function SocketService() {
    ...
    function handle(conn) {
        ...
        var fdSendData = Future.wrap(function(data, id) {
            var len = data.length;
        ...
        function fdhandle(data, context, id) {
            fdSendData(self.defaultHandle(data, context), id);
        }
        var hdSendData = Future.wrap(function(data) {
            var len = data.length;
        ...
        function hdhandle(data, context) {
            hdSendData(self.defaultHandle(data, context));
        }
